...
def fitness(individual, clf, data):
    ...
    print(
        ...
        accuracy_score(data[3], predicted_labels, normalize=False),
    )

    c1_miss_percent, c2_miss_percent = get_class_miss_percentages(
        data[3], predicted_labels
    )
    f_result = int(c1_miss_percent * c2_miss_percent * (fs_cost // 100))
